defmodule NoterWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <header :if={false} class="navbar px-4 sm:px-6 lg:px-8 bg-base-200 border-b border-base-300">
      <div class="flex-1">
        ...
        >
          <.icon name="hero-book-open" class="size-6" /> Noter
        </a>
      </div>
      <div class="flex-none">
        <.theme_toggle />
  ...
  def theme_toggle(assigns) do
    ...
    <div class="card relative flex flex-row items-center border-2 border-base-300 bg-base-300 rounded-full">
      <div class="absolute w-1/3 h-full rounded-full border-1 border-base-200 bg-base-100 brightness-200 left-0 [[data-theme=retro]_&]:left-1/3 [[data-theme=dim]_&]:left-2/3 transition-[left]" />
